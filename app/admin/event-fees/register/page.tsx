...
type AdminEventFeeRegisterPageProps = {
...
export default async function AdminEventFeeRegisterPage({
  searchParams,
}: AdminEventFeeRegisterPageProps) {
  ...
  return (
    <EventFeeRegisterView
      register={register}
      basePath="/admin/event-fees/register"
      showAdminLinks
